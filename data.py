...
pygame.mixer.init()
main_menu_music = pygame.mixer.Sound(os.path.join(SOUND_PATH, 'menu.mp3'))
playing_music = pygame.mixer.Sound(os.path.join(SOUND_PATH, 'playing.mp3'))
victory_music = pygame.mixer.Sound(os.path.join(SOUND_PATH, 'ivictory.mp3'))
lose_music = pygame.mixer.Sound(os.path.join(SOUND_PATH, 'lose.mp3'))
bow_shoot_sound = pygame.mixer.Sound(os.path.join(SOUND_PATH, 'ibow_shoot.mp3'))
sword_hit_sound = pygame.mixer.Sound(os.path.join(SOUND_PATH, 'sword_hit.mp3'))
char_hit_sound = pygame.mixer.Sound(os.path.join(SOUND_PATH, 'char_hit.mp3'))
enemy_hit_sound = pygame.mixer.Sound(os.path.join(SOUND_PATH, 'enemy_hit.mp3'))
take_item_sound = pygame.mixer.Sound(os.path.join(SOUND_PATH, 'itake_item.mp3'))
